...
var LiteralEdit = RDFauthor.createWidget();

LiteralEdit.prototype.name = 'LiteralEdit';

LiteralEdit.prototype.init = function () {
...
LiteralEdit.prototype.element = function () {
    return jQuery('#literal-value-' + this.ID);
}

LiteralEdit.prototype.markup = function () {
    var areaConfig = {
...
LiteralEdit.prototype.remove = function () {
    this.removeOnSubmit = true;
}

LiteralEdit.prototype.submit = function () {
    alert('Submit');
}

// RDFauthor.loadScript(RDFAUTHOR_BASE + 'libraries/autoresize.jquery.min.js');
RDFauthor.registerWidget({constructorFunction: LiteralEdit, hookName: '__LITERAL__'});